...
const getReview = async (req, res) => {
    try {
        ...
        res.status(500).json({ 
            status: 500,
            message: 'Unable to get the review!', error 
        });
    }
};
...
const getReviews = async (req, res) => {
    try {
        ...
        res.status(500).json({ 
            status: 500,
            message: 'Unable to get the reviews for the recipe!', error 
        });
    }
};
...
const getUserReviews = async (req, res) => {
    try {
        ...
        res.status(500).json({ 
            status: 500,
            message: 'Unable to get the reviews for the user!', error 
        });
    }
};
...
const createReview = async (req, res) => {
    try {
        ...
        res.status(500).json({ 
            status: 500,
            message: 'Unable to create the review!', error 
        });
    }
};
...
const updateReview = async (req, res) => {
    try {
        ...
        res.status(500).json({ 
            status: 500,
            message: 'Unable to update the review!', error });
    }
};
...
const deleteReview = async (req, res) => {
    try {
        ...
        res.status(500).json({ 
            status: 500,
            message: 'Unable to delete the review!', error 
        });
    }
};
